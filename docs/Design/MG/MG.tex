...
\begin{description}
	...
	link between the client programs and the inner \famname{}
        modules. \wss{I'm interested in this approach.  I wonder if you are just
          going to be renaming the access programs for the modules that this
          module uses.  In that case, this module wouldn't likely be that
          useful.  We'll have a better idea as you develop your MIS.}
