...
assumptions related to the input data. \hz{referencing the assumption that the 
inequalities are "less than or equal to"}
...
\item[\refstepcounter{ucnum} \uctheucnum \label{ucInput}:] There will always be
  a source of input data external to the software. \hz{does this mean the 
  client that will provide the inputs?}
...
\item [\refstepcounter{mnum} \mthemnum \label{mOF}:] Output Module
\item [\refstepcounter{mnum} \mthemnum \label{mEI}:] External Interface Module
\item [\refstepcounter{mnum} \mthemnum \label{mSMax}:] Simplex Method Solver 
for Maximization Problems
\item [\refstepcounter{mnum} \mthemnum \label{mSMin}:] Simplex Method Solver 
