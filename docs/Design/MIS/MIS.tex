...
\begin{itemize}
	...
	$\Rightarrow$ INVALID{\_}INPUT \wss{This is math, not a programming
          language, so tests for equality just  use $=$}\\
...
\begin{itemize}
	...
	\end{enumerate} \wss{Use a conditional rule to express this}
	\item output: -
	\item exception: -
\end{itemize}
