...
\wss{I suggest you give the specific names of the modules that will be
  verified.  A reference to the MG would also be a good idea.}
...
\hz{fix labels of test cases in system plan and use cross-ref here} 
...
\begin{enumerate}
	...
	\item{\textbf{T\refstepcounter{testnum}\thetestnum \label{canonicalMax}: 
	...
	(from calling getLCsType()), the slack variables are added to the
        matrix} \\
	...
	\item{\textbf{T\refstepcounter{testnum}\thetestnum \label{canonicalSlack}: 
	...
	\item{\textbf{T\refstepcounter{testnum}\thetestnum \label{canonicalMin}: 
	...
	\item{\textbf{T\refstepcounter{testnum}\thetestnum 
...
\begin{enumerate}
	...
	\item{\textbf{T\refstepcounter{testnum}\thetestnum \label{solveLpMinZ}: 
	...
	\item{\textbf{T\refstepcounter{testnum}\thetestnum \label{solveLpMinK}: 
	...
	\item{\textbf{T\refstepcounter{testnum}\thetestnum \label{solveLpMaxZ}: 
	...
	\item{\textbf{T\refstepcounter{testnum}\thetestnum \label{solveLpMaxK}: 
	...
	\item{\textbf{T\refstepcounter{testnum}\thetestnum \label{solveLpNoSol}: 
